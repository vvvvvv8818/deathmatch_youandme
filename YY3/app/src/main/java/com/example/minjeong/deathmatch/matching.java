...
public class matching extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gamechoice = (Button) findViewById(R.id.gamechoice);
...
// Get local Bluetooth adapter
        ...
        research.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                serverIntent = new Intent(matching.this, DeviceListActivity.class);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MESSAGE_READ:
                    ...
                    if (msg.arg2 == 1) {
                        System.out.println("@@@ C&C MESSAGE_READ");
                        Comcon.receiveMessage(readMessage);
                    } else if (msg.arg2 == 2) {
                        System.out.println("@@@ 12 MESSAGE_READ");
                        KoreanChess.receive_data(readMessage);
                        /**
                         *
                         */
                    } else if (msg.arg2 == 3) {
                        System.out.println("@@@ DP MESSAGE_READ");
